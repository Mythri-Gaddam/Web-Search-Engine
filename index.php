...
$div =true;
$results = $solr->search($query, 0, $limit, $additionalParameters);
$link = "http://localhost/solr-php-client/index.php?q=$correct&sort=$choice";
...
$csvArray =  array_map('str_getcsv', file('/home/user/Downloads/URLtoHTML_nypost.csv'));
$count =0;
$pre="";
// display results
if ($results)
...
<?php
  ...
  foreach ($results->response->docs as $doc)
  {
    ...
    $id = $doc->id;
    $or_id = $id;
    $id = str_replace("/home/user/Downloads/nypost/","",$id);
...
$ar = explode(" ", $searchterm);
    $html_text = "/home/user/Downloads/nypost/";
